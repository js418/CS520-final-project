...
while(<IN>) {
    ...
    my ($Project,$Bug,$TestSuite,$ScoringScheme,$Family,$Formula,$TotalDefn,$KillDefn,$HybridScheme,$AggregateDefn,$Score,$ScoreWRTLoadedClasses) = split /,/;
    my $key = "$Project,$Bug,$TestSuite,first,$Family,$Formula,$TotalDefn,$KillDefn,$HybridScheme,$AggregateDefn";
...
while(<IN>) {
    my $line = $_; chomp $line;
    my ($Project,$Bug,$TestSuite,$ScoringScheme,$Family,$Formula,$TotalDefn,$KillDefn,$HybridScheme,$AggregateDefn,$Score,$ScoreWRTLoadedClasses) = split /,/;
    my $key = "$Project,$Bug,$TestSuite,$ScoringScheme,$Family,$Formula,$TotalDefn,$KillDefn,$HybridScheme,$AggregateDefn";
    # Simply duplicate the data rows for artificial faults -- the results for all scoring schemes are identical.
    if ($Bug > 1000) {
        print "$Project,$Bug,$TestSuite,first,$Family,$Formula,$TotalDefn,$KillDefn,$HybridScheme,$AggregateDefn,$Score,$ScoreWRTLoadedClasses";
        print "$Project,$Bug,$TestSuite,median,$Family,$Formula,$TotalDefn,$KillDefn,$HybridScheme,$AggregateDefn,$Score,$ScoreWRTLoadedClasses";
        print "$Project,$Bug,$TestSuite,last,$Family,$Formula,$TotalDefn,$KillDefn,$HybridScheme,$AggregateDefn,$Score,$ScoreWRTLoadedClasses";
        next;
    }
    # Sanity checks:
